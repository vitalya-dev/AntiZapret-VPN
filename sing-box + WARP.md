...
Мы специально завернули трафик OpenAI в WARP, потому что сайт ChatGPT работает через Cloudflare. Это дает быстрый способ протестировать работу  туннеля ,обратившись к служебной странице трассировки (`/cdn-cgi/trace`).
